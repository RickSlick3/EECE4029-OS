...
void *philosopher_program(int philosopher_number)
   {  
      ...
      while (MEALS_ON_TABLE > 0)
	   ...
	   // SINCE THE CHOPSTICKS THAT THE PHILOSOPHER WANTS TO PICK UP ARE RANDOM, THEIR PHIL_NUM
	   // DOESN'T MATTER, ONLY THE NUMBER OF THE CHOPSTICKS DO

           // THIS CHECKS TO SEE WHICH CHOPSTICK TO PICK UP FIRST (LOWER NUMBER) DEPENDENT ON
           // THE CHOPSTICK NUMBERS THEY WANT TO PICK UP

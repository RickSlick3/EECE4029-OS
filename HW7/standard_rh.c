...
void *philosopher_program(int philosopher_number)
   {  // In this version of the "philosopher program", the philosopher
      ...
      while (MEALS_ON_TABLE > 0)
	   ...
	   // EACH PHILOSOPHER WILL PICK OP THE CHOPSTICK TO THE LEFT (THE SAME # CHOPSTICK
	   // AS THEIR PHIL_NUM) BEFORE THE CHOPSTICK TO THEIR RIGHT (PHIL_NUM + 1) EXCEPT FOR 
	   // THE HIGHEST NUMBER PHIL WHO WILL PICK UP THE ONE TO THEIR RIGHT FIRST
	   // (PHIL_NUM + 1 % PHIL_COUNT)

	   // THIS CHECKS TO SEE WHICH CHOPSTICK TO PICK UP FIRST (LOWER NUMBER) DEPENDENT ON
	   // THEIR PHILOSOPHER NUMBER

...
void *philosopher_program(int philosopher_number)
   {  // In this version of the "philosopher program", the philosopher
      ...
      while (MEALS_ON_TABLE > 0)
	   ...
	   // IF THE PHILOSOPHER BEFORE THE CURRENT ONE BEING WAITED ON IS A NEIGHBOR TO THE CURRENT
	   // PHILOSOPHER, THEN THE CURRENT PHILOSOPHER WILL HAVE TO WAIT FOR THEM TO PUT DOWN THEIR
	   // CHOPSTICKS BEFORE MOVING ON.

	   // THIS MEANS THAT NO OTHER PHILOSOPHER CAN BE WAITED ON UNTIL BOTH CHOPSTICKS ARE AVAILIBLE

	   // OTHERWISE, IF BOTH ARE AVAILIBLE THE N THE PHILOSOPHER CAN PICK THEM UP AND SEND THE WAITER 
	   ...
	   // THE ARBITER CAN UNLOCK HERE BECAUSE THE CURENT PHILOSOPHER WOULD HAVE BOTH OF THEIR CHOPSTICKS
